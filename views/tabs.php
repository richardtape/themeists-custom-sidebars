...
<a class="nav-tab <?php echo $tabconfig; ?>" href="themes.php?page=ThemeistsCustomSidebars"><?php _e('Custom Sidebars','custom-sidebars'); ?></a>
<a class="nav-tab <?php echo $tabdefaults; ?>" href="themes.php?page=ThemeistsCustomSidebars&p=defaults"><?php _e('Default Sidebars','custom-sidebars'); ?></a>
