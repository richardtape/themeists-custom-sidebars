...
<div id="cs-widgets-extra">
    ...
    <div id="cs-title-options">
        ...
        <div id="cs-options" class="cs-options" style="text-align:right">
            <span><img src="<?php echo esc_url( admin_url( 'images/wpspin_light.gif' ) ); ?>" class="ajax-feedback" title="" alt=""></span><a href="themes.php?page=ThemeistsCustomSidebars" class="button create-sidebar-button"><?php _e('Create a new sidebar','custom-sidebars') ?></a>
        </div>
    </div>
    <div id="cs-new-sidebar" class="widgets-holder-wrap">
        <div class="sidebar-name">
            <div class="sidebar-name-arrow"><br></div>
            <h3><?php _e('New Sidebar','custom-sidebars') ?><span><img src="<?php admin_url( 'images/wpspin_dark.gif' ); ?>" class="ajax-feedback" title="" alt=""></span></h3>
        </div>
            ...
            <div class="sidebar-form">
                <form action="themes.php?page=ThemeistsCustomSidebars" method="post">
                    ...
                    <p class="submit submit-sidebar">
                        <span><img src="<?php admin_url( 'images/wpspin_light.gif' ); ?>" class="ajax-feedback" title="" alt=""></span>
    ...
    <div class="cs-edit-sidebar"><a class="where-sidebar thickbox" href="<?php echo admin_url('admin-ajax.php'); ?>?action=cs-ajax&cs_action=where&id=" title="<?php _e('Where do you want the sidebar?','custom-sidebars') ?>"><?php _e('Where?','custom-sidebars')?></a><span class="cs-edit-separator"> | </span><a class="edit-sidebar" href="themes.php?page=ThemeistsCustomSidebars&p=edit&id="><?php _e('Edit','custom-sidebars')?></a><span class="cs-edit-separator"> | </span><a class="delete-sidebar" href="themes.php?page=ThemeistsCustomSidebars&p=delete&id="><?php _e('Delete','custom-sidebars')?></a></div>
    <div class="cs-cancel-edit-bar"><a class="cs-advanced-edit" href="themes.php?page=ThemeistsCustomSidebars&p=edit&id="><?php _e('Advanced Edit', 'custom-sidebars') ?></a><span class="cs-edit-separator"> | </span><a class="cs-cancel-edit" href="#"><?php _e('Cancel', 'custom-sidebars') ?></a></div>
