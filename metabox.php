...
<?php endforeach; else: ?>
	<p id="message" class="updated"><?php _e('There are no replaceable sidebars selected. You can define what sidebar will be able for replacement in the <a href="themes.php?page=ThemeistsCustomSidebars">Custom Sidebars config page</a>.','custom-sidebars')?></p>
<?php endif;?> 